...
function generateScript() {
    ...
    //var outsiderssHeight = Number(roleHeightslider.value * OutsiderLines) + Number(MinionOffsetSlider.value) + "px";
    ...
    //var minionsHeight = Number(roleHeightslider.value * MinionLines) + Number(DemonOffsetSlider.value) + "px";
    ...
    //var demonsHeight = Number(roleHeightslider.value * DemonLines) + "px";
    //document.documentElement.style.setProperty("--scriptpanel-demon-height", demonsHeight);

    var townsfolksHeight = Number(roleHeightslider.value * TownsfolkLines) + Number(TownsfolkOffsetSlider.value) + Number(TitleHeightSlider.value) + Number(75) + "px";
    ...
    var outsiderssHeight = Number(roleHeightslider.value * OutsiderLines) + Number(MinionOffsetSlider.value) + Number(75) + "px";
    ...
    var minionsHeight = Number(roleHeightslider.value * MinionLines) + Number(DemonOffsetSlider.value) + Number(75) + "px";
    ...
    var demonsHeight = Number(roleHeightslider.value * DemonLines) + Number(75) + "px";
    ...
    html += "<div class='scriptpanel-townsfolk'><span class='scriptpanel-text'>Měšťan</span></div>";
    html += "<div class='scriptpanel-outsider'><span class='scriptpanel-text'>Podivín</span></div>";
    html += "<div class='scriptpanel-minion'><span class='scriptpanel-text'>Přisluhovač</span></div>";
    html += "<div class='scriptpanel-demon'><span class='scriptpanel-text'>Démon</span></div>";
    html += "</div>";
    ...
    Object.values(jinxData).forEach(sheet => {
        sheet.forEach(row => {
            ...
            if (idList.includes(first) && idList.includes(second)) {
                ...
                html += "</span><span style='color:black;'> & </span>";
                html += "<span ";
...
function updateTitleHeight() {
    ...
    const offSetPanel = Number(heightSlider) + Number(40) + "px"; //25 je polovina velikosti separatoru + 15 margin u nadpisu
